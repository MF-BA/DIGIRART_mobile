...
// Set the background color to black
    ...
    private void addButton(Room rec, Resources res) {
        ...
        objetTxt.getAllStyles().setFgColor(0xFFFFFF); // Set the foreground color to white
        dateTxt.getAllStyles().setFgColor(0xFFFFFF); // Set the foreground color to white
        state.getAllStyles().setFgColor(0xFFFFFF); // Set the foreground color to white
        etatTxt.getAllStyles().setFgColor(0xFFFFFF); // Set the foreground color to white
