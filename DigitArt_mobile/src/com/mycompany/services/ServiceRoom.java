...
// Update Room
    ...
    public ArrayList<Room> getAvailableRooms() {
        String url = Statics.BASE_URL + "/room/mobile/getAvailableRooms";
        ...
        NetworkManager.getInstance().addToQueueAndWait(req);
        System.out.println("service :    " + RoomAvailable);
        return RoomAvailable;
    }
    
    
     public ArrayList<users> getArtists() {
        String url = Statics.BASE_URL + "/room/mobile/getArtists";
        ...
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            ...
            public void actionPerformed(NetworkEvent evt) {
                ...
                try {
                    Map<String, Object> mapArtists = jsonp.parseJSON(new CharArrayReader(new String(req.getResponseData()).toCharArray()));

                    List<Map<String, Object>> listOfMaps = (List<Map<String, Object>>) mapArtists.get("root");
        ...
        NetworkManager.getInstance().addToQueueAndWait(req);
        System.out.println("service :    " + Artists);
        return Artists;
    }
